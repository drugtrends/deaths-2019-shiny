...
tabPanel("Drug-induced deaths by drug, jurisdiction and intent",
  ...
  #       Below based on: https://shiny.rstudio.com/reference/shiny/1.0.4/renderUI.html
             ...
             conditionalPanel(
                 condition = "input.DropDT == 'Intent'",
                   selectInput("codDTI", NULL,
      ...
      # Opioids by opioid, age and intent (Table 4) -----------------------------------------
        ...
        tabsetPanel(
          ...
          tabPanel(
            "Plot",
            mainPanel(
              withLoader(plotlyOutput("opioidPlotA", width = "100%", height = "600px"), 
     #           type = "html", loader = "loader4"),
                  type="image", loader="DT_NIDIP_tween.gif"),
  ...
  tabPanel(
    ...
    tabsetPanel(
      ...
      tabPanel(
        ...
        sidebarPanel(
          sliderInput("years10", "Period",
                      min = 2007,
                      max = 2018, value = c(2008, 2018), sep = ""
          ),
          selectInput( "plot10", "Plot:",
                       c( "Number of deaths" = "deaths",
                          "Deaths per 100,000 people" = "deathrateht",
                          "Deaths per 100,000 people (95% CI)" = "deathratehtci",
                          "Deaths per 1,000,000 people" = "deathratem",
...
#  renderCSS(type="image", loader="DT_NIDIP_onion30.gif"),
  tags$style(type = 'text/css', '.navbar { background-color: #6e2a8d;}'
            ...
            , '.irs-from, .irs-to, .irs-single {background: #475c07;}' #color for year sliders
            , '.irs-bar { border-top: 1px solid #465d02;
              border-bottom: 1px solid #475c07;
              background: #465d02; }'
            , '.navbar-default .navbar-nav>.active>a:focus {background-color: #475c07;}'
#            , 'td, th { padding: 10; }' #doesn't work
